...
export function IconHomeNavigation() {
    return (
        <svg
...
export function IconGrayArchive() {
    return (
        <svg
...
export function IconGraySnooze() {
    return (
        <svg
            className="dropdown-icon text-gray-400 me-2"
            fill="currentColor"
